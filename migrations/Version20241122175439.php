 ...
 */
final class Version20241122175439 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE developer DROP project_id, CHANGE phone phone VARCHAR(20) NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE developer ADD project_id INT NOT NULL, CHANGE phone phone VARCHAR(255) NOT NULL');
